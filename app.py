...
with tab3:
    ...
    st.caption(f"OPEX 合計：NT$ {may_total:,}（三邊現金流出總額 1,784,441，另含出團成本 102,646、營所稅 156,615、待確認匯出 198,250，未列於本表）")
